...
*   [AvoidDebugStatementsInLoops](pmd_rules_apex_performance.html#avoiddebugstatementsinloops): Avoid Debug statements inside loops to avoid hitting the CPU time limit. Instead, try to debug ou...
