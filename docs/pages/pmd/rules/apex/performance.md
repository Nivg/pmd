...
keywords: Performance, AvoidDmlStatementsInLoops, AvoidSoqlInLoops, AvoidSoslInLoops, AvoidDebugStatementsInLoops
language: Apex
---
<!-- DO NOT EDIT THIS FILE. This file is generated from file ../pmd-apex/src/main/resources/category/apex/performance.xml. -->
## AvoidDebugStatementsInLoops

**Since:** PMD 6.0.0

**Priority:** Medium (3)

Avoid Debug statements inside loops to avoid hitting the CPU time limit. Instead, try to debug outside the loop but consider delete the debug statement in the end to keep clean code.

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.apex.rule.performance.AvoidDebugStatementsInLoopsRule](https://github.com/pmd/pmd/blob/master/pmd-apex/src/main/java/net/sourceforge/pmd/lang/apex/rule/performance/AvoidDebugStatementsInLoopsRule.java)
...
``` xml
<rule ref="category/apex/performance.xml/AvoidDebugStatementsInLoops" />
```
